...
class CanvasSenpai {
  ...
  async welcome(member, { link, gradiant, blur, block } = {}) {
   blur !== false ? blur = true : blur
    ...
    let xname = member.displayName;

    ctx.font = `Poppins-SemiBold 50px ${font}`;
    ctx.fillStyle = "#f4fc03";
    ctx.strokeStyle = "#000000";
    var textString = `${xname}`,    
        textWidth = ctx.measureText(textString).width;

    ctx.fillText(`${xname}`,(canvas.width/2) - (textWidth/2),360);
    ctx.strokeText(`${xname}`,(canvas.width/2) - (textWidth/2),360);

    //////////////////////////////////////////////////////////////////////////////////////////////////////////
    ctx.font = `Poppins-SemiBold 40px ${font}`;
    ctx.fillStyle = "#Fc0341";
    ctx.strokeStyle = "#000000";
    var textString = `Welcome to`,    
        textWidth = ctx.measureText(textString).width;

    ctx.fillText(`Welcome to`,(canvas.width/2) - (textWidth/2),405);
    ctx.strokeText(`Welcome to`,(canvas.width/2) - (textWidth/2),405);

    ////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ctx.font = `Poppins-SemiBold 35px ${font}`;
    ctx.fillStyle = "#FFFFFF";
    ctx.strokeStyle = "#000000";
    var textString = `${member.guild.name}`,    
        textWidth = ctx.measureText(textString).width;

    ctx.fillText(`${member.guild.name}`,(canvas.width/2) - (textWidth/2),445);
    ctx.strokeText(`${member.guild.name}`,(canvas.width/2) - (textWidth/2),445);

    ////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ctx.fillStyle = "#FFFFFF";
    ctx.arc(500, 174.5, 132, 0, 2 * Math.PI);
    ctx.fill();
    ...
    ctx.drawImage(avatar, 375, 50, 250, 250);
